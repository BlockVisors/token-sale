  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to the Reserv Token Sale </h1>
          <div className={styles.description}>
            You can claim or mint Reserv token(RESX) here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
              ...
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                Overall {utils.formatEther(tokensMinted)}/21,000,000 have been minted!!!
              </div>
              {renderButton()}
            </div>
          ) : (
